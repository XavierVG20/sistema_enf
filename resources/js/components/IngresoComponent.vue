                ...
                <template v-if="listado == 1">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <button type="submit" @click="listarIngreso(1, buscar, criterio)" class="btn btn-primary"><i
                                    ...
                                    <div class="form-group row border">
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <v-select :on-search="selectProveedor" label="nombre"
                                                    :options="arrayProveedor" placeholder="Buscar Proveedores..."
                                        ...
                                        <div class="col-md-12">
                                            <div v-show="errorIngreso" class="form-group row div-error">
                                                <div class="text-center text-error">
                                                    <div v-for="error in errorMostrarMsjIngreso" :key="error"
                                                        v-text="error">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody v-if="arrayDetalle.length">
                                                    <tr v-for="(detalle, index) in arrayDetalle" :key="detalle.id">
                                                        ...
                                                        <td>
                                                            <input v-model="detalle.precio" type="number" value="3"
                                                                class="form-control">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr style="background-color: #CEECF5;">
                                                        ...
                                                        <td>$ {{ totalImpuesto=((total * impuesto) / (1 + impuesto)).toFixed(2) }}
                                                        </td>
                                                    </tr>
                                                    <tr style="background-color: #CEECF5;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <button type="button" class="btn btn-success pull-right"
                                                @click="registrarIngreso()"> Registrar
                                                Compra
                                            </button>
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12">
                                            <a @click="ocultarDetalle()" class="btn btn-danger pull-right">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" v-model="buscarA"
                                                @keyup.enter="listarArticulo(buscarA, criterioA)" class="form-control"
