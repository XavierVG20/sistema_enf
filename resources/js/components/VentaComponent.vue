                        ...
                        <div class="col-md-4">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> Informtacion Generar</h3>
                                </div>
                                <div class="box-body">
                                            ...
                                            <table class="table table-bordered table-striped table-sm">
                                                ...
                                                <tbody v-if="arrayDetalle.length">
                                                    <tr v-for="(detalle, index) in arrayDetalle" :key="detalle.id">
                                                        ...
                                                        <td>
                                                            <input v-model="detalle.precio" type="number"
                                                                class="form-control">
                                                        </td>
                                                        <td>
                                                            <span style="color:red;"
                                                                v-show="detalle.cantidad > detalle.stock">Stock:
                                                                {{ detalle.stock }}</span>
                                                        ...
                                                        <td>
                                                            <span style="color:red;"
                                                                ...
                                                                superior</span>
                                                            <input v-model="detalle.descuento" type="number"
                                                                class="form-control">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr style="background-color: #CEECF5;">
                                                        ...
                                                        <td>$ {{ totalImpuesto=((total * impuesto) / (1 +
                                                            impuesto)).toFixed(2) }}</td>
                                                    </tr>
                                                    <tr style="background-color: #CEECF5;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <button type="button" class="btn btn-success pull-right"
                                                @click="registrarVenta()"> Registrar venta
                                            </button>
